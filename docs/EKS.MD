...
### Prerequisites
    ...
    9.  (Optional) Install the Kubernetes Dashboard for managing and troubleshooting your cluster
        ...
        f. See also 
           ...
           --  https://github.com/AcalephStorage/kubernetes-dashboard/blob/master/docs/user-guide/troubleshooting.md
...
#### Create Deployment
	...
	2.  $ kubectl apply -f deployment.yaml    ## This creates the PODs that run the application and a ReplicaSet to manage the lifecycle of pods 

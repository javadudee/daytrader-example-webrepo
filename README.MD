...
This README shows how to put the Web UI in a Docker Image and how to deploy that Docker Image to Kubernetes. 
...
1.  The Web UI application codebase was 100% portable across the Kubernetes platforms that we tested.
...
1.  All configuration files and `kubectl` commands were 100% portable across the Kubernetes platforms we tested.

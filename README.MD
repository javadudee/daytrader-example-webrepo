...
This README shows how to generate a Docker Image for the Web and how to Deploy that Docker Image to a Kubernetes Cluster. 
...
4.  Access the Swagger UI
    ...
    a.  Post-Condition: Stop the microservices
